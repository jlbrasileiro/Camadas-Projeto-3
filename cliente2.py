...
def main():
    try:
        ...
        while True:
            if pause:
                despausar= int(input("deseja despausar? (0 para nao 1 para sim) "))
                if despausar==1:
                    pause=False
            ...
            if correto==True:
                ...
                print("------------------------------------------------------------------------------------------------------------")
                podePausar = 100*numero/total
                if podePausar%25 == 0:
                    print("------------------------------------------------------------------------------------------------------------\n\n")
                    print(f"já foi {podePausar}%")
                    pausa = int(input("deseja pausar? (0 para nao 1 para sim) "))
                    if pausa ==1:
                        pacote=cria_pacote(index=2,total=total,nPacote=numero,payload=b'00')
                        print("pausado")
                        pause = True
                    print("------------------------------------------------------------------------------------------------------------")
